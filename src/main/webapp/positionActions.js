...
function searchPosition() {
    ...
    var searchUrl = "/HREmpower/rest/positions";
...
$('.table').on('click', '.delete-position', function(e) {
    ...
    var deleteUrl = '/HREmpower/rest/positions/' + $id;
 ...
 */
$('.table').on('click', '.edit-position', function() {
    ...
    var editUrl = '/HREmpower/rest/positions/' + $positionId;
    var operations = [];
    var newPosition = {
        addRequirement: [],
        removeRequirement: [],
    ...
    $('#dialog-add-applications-button').on('click', function() {
        // Add new row
        $.get("/HREmpower/position/addApplicant.html", function(data) {
...
function searchMatch() {
    ...
    var searchUrl = "/HREmpower/rest/positions/match/" + $positionID;
