...
function searchCandidate() {
    ...
    var searchUrl = "/HREmpower/rest/candidates";
...
$('.table').on('click', '.delete-candidate', function(e) {
    ...
    var deleteUrl = '/HREmpower/rest/candidates/' + $id;
 ...
 */
$('.table').on('click', '.edit-candidate', function() {
    ...
    var editUrl = '/HREmpower/rest/candidates/' + $candidateId;
    var operations = [];
    var newCandidate = {
        addExperience: [],
        removeExperience: [],
