...
function searchHR() {
    ...
    var searchUrl = "/HREmpower/rest/hrs";
...
$('.table').on('click', '.delete-hr', function(e) {
    ...
    var deleteUrl = '/HREmpower/rest/hrs/' + $id;
 ...
 */
$('.table').on('click', '.edit-hr', function() {
    ...
    var editUrl = '/HREmpower/rest/hrs/' + $hrId;
    var operations = [];
    var newHR = {};
