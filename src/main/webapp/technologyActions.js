...
function addTechnology() {
    ...
    if (isExecutableAjax) {
        ...
        $.ajax({
            method: 'POST',
            async: false,
            url: '/HREmpower/rest/technologies',
            dataType: 'json',
...
function searchTechnology() {
    ...
    var searchUrl = "/HREmpower/rest/technologies";
...
$('.table').on('click', '.delete-technology', function(e) {
    ...
    var deleteUrl = '/HREmpower/rest/technologies/' + $id;
 ...
 */
$('.table').on('click', '.edit-technology', function() {
    ...
    var editUrl = '/HREmpower/rest/technologies/' + $technologyId;
    var newTechnology = {};
