...
function searchCompany() {
    ...
    var searchUrl = "/HREmpower/rest/companies";
...
$('.table').on('click', '.delete-company', function(e) {
    ...
    var deleteUrl = '/HREmpower/rest/companies/' + $id;
...
$('.table').on('click', '.edit-company', function(e) {
    ...
    var editUrl = '/HREmpower/rest/companies/' + $companyId;
    var newCompany = {};
     ...
     */
    $('#save-company-changes-button').one('click', function() {
        ...
        // Execute the ajax call to edit the Company.
        $.ajax({
            method: 'POST',
            url: editUrl,
            dataType: 'json',
