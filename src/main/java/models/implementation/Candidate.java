...
public class Candidate extends Entity implements Comparable<Candidate> {
    ...
    /**
     * Method which sorts the Candidates by rating in descending order.
     * @param candidate the Candidate with which to compare ratings.
     * @return the Candidate sorted in descending order.
     */
